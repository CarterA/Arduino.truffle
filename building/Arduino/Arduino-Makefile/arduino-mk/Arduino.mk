...
ifndef BOARD_TAG
BOARD_TAG = $(shell grep board $(wildcard $(ARDUINO_PREFERENCES_PATH)) | cut -d = -f 2)
endif
...
ifndef PARSE_BOARD
PARSE_BOARD = "$(ARDMK_DIR)/bin/ard-parse-boards" --boards_txt=$(BOARDS_TXT)
endif
...
OBJDIR  	  = $(CHOC_BUILD_DIR)/$(CHOC_FILENAME_NOEXT).build
...
# Include /utility folders if they exist for any libraries
SYS_LIBS  += $(wildcard $(patsubst %,%/utility,$(SYS_LIBS)))
USER_LIBS += $(wildcard $(patsubst %,%/utility,$(USER_LIBS)))
...
export ARD_PORT := $(firstword $(wildcard $(ARDUINO_PORT)))
...
ifndef SERIAL_MONITOR_BAUD_RATE
SERIAL_MONITOR_BAUD_RATE = 9600
endif

ifndef SERIAL_MONITOR_BINARY
SERIAL_MONITOR_BINARY = screen
endif

ifndef SERIAL_MONITOR_FLAGS
SERIAL_MONITOR_FLAGS = -c "$(SCREENRC)" $(ARD_PORT) $(SERIAL_MONITOR_BAUD_RATE)
endif
